...
//    private List<CustomerResponse> CustomerItems;
    private List<CustomerRealm> CustomerItems;

//    public CustomerListAdapter(Activity activity, List<CustomerResponse> CustomerItems) {
//        this.activity = activity;
//        this.CustomerItems = CustomerItems;
//    }

    public CustomerListAdapter(Activity activity, List<CustomerRealm> CustomerItems) {
        this.activity = activity;
        this.CustomerItems = CustomerItems;
    }
...
//        CustomerResponse m = CustomerItems.get(position);
        CustomerRealm m = CustomerItems.get(position);
